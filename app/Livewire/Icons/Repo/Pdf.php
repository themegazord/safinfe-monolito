...
class Pdf extends Component
{
    ...
    {
        return <<<'HTML'
            <svg height="{{ $this->defineTamanho }}px" width="{{ $this->defineTamanho }}px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                viewBox="0 0 512 512"  xml:space="preserve">
                <style type="text/css">
                    .st0{fill:{{ $this->defineCor }};}
                </style>
                <g>
