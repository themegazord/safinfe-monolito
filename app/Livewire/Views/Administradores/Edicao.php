...
class Edicao extends Component
{
    ...
    public function editar()
    {
        ...
        if (! is_null($administradorValidadoEmail) && $this->administradorAtual['id'] !== $administradorValidadoEmail->getAttribute('id')) {
            return $this->addError('administrador.email', 'O email já está sendo usado por outro usuario, escolha outro.');
        }
