...
{
    use AnalisaCOFINSSTXMLTrait, AnalisaCOFINSXMLTrait, AnalisaICMSUFDestXMLTrait, AnalisaICMSXMLTrait, AnalisaIIXMLTrait, AnalisaInfAdicionalTrait, AnalisaIPIXMLTrait, AnalisaISSQNTXMLTrait, AnalisaPagamentosTrait, AnalisaPISSTXMLTrait, AnalisaPISXMLTrait, Toast, WithPagination;
    ...
    {
        if (! empty($this->diretorioUsuario)) {
            $this->removePasta($this->diretorioUsuario);
        }
        if (! empty($this->diretorioRARUsuario)) {
            $this->removePasta($this->diretorioRARUsuario);
        }
    }
