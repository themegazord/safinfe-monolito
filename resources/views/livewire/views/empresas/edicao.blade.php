<div class="p-4 md:p-6">
  <h1 class="font-bold text-2xl mb-4">Edição de Empresas</h1>
  <form wire:submit="editar">
    <h5 class="font-bold text-xl mb-2">Dados da empresa:</h5>
    <div class="flex flex-col gap-4">
      <x-input label="Insira o nome fantasia da empresa" placeholder="Insira o nome fantasia da empresa..." value="{{ $empresaAtual['fantasia'] }}" wire:model.fill="empresa.fantasia" />
      ...
      <x-input label="Insira o email de contato da empresa" placeholder="Insira o email de contato da empresa..." value="{{ $empresaAtual['email_contato'] }}" wire:model.fill="empresa.email_contato" />
      <div class="flex flex-col md:grid md:grid-cols-2 gap-4">
        <div class="col-span-1">
          <x-input label="Insira o telefone de contato da empresa" placeholder="Insira o telefone de contato da empresa..." value="{{ $empresaAtual['telefone_contato'] }}" wire:model.fill="empresa.telefone_contato" />
        </div>
        <div class="col-span-1">
          <x-input label="Insira o telefone reserva da empresa" placeholder="Insira o telefone reserva da empresa..." value="{{ $empresaAtual['telefone_reserva'] }}" wire:model.fill="empresa.telefone_reserva" />
        </div>
      </div>
      <div class="divider"></div>
      ...
      <div class="flex flex-col md:grid md:grid-cols-5 gap-4">
        <div class="col-span-4">
          <x-input label="Insira a rua" placeholder="Insira a rua..." value="{{ $enderecoAtual['rua'] }}" wire:model.fill="endereco.rua" />
        </div>
        <div class="col-span-1">
          <x-input label="Numero" placeholder="Numero da casa..." value="{{ $enderecoAtual['numero'] }}" wire:model.fill="endereco.numero" />
        </div>
      </div>
      <div class="flex flex-col md:grid md:grid-cols-2 gap-4">
        <div class="col-span-1">
      ...
      <x-textarea rows="3" label="Insira o complemento" placeholder="Insira o complemento..." value="{{ $enderecoAtual['complemento'] }}" wire:model.fill="endereco.complemento" />
      <div class="flex flex-col md:grid md:grid-cols-2 gap-4">
        @php
        $estados = [
        ['uf' => 'AC', 'estado' => 'Acre'],
        ...
        @endphp
        <div class="col-span-1">
          <x-input label="Insira o cidade" placeholder="Insira o cidade..." value="{{ $enderecoAtual['cidade'] }}" wire:model.fill="endereco.cidade" />
        </div>
        <div class="col-span-1">
          <x-select
    ...
    <div class="flex flex-col sm:flex-row-reverse gap-4 mt-4">
      <x-button type="submit" class="btn btn-success" label="Salvar" spinner="editar"/>
